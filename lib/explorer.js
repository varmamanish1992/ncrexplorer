...
module.exports = {
 ...
 if (settings.nethash_units == 'K') {
                return cb((body.netstakeweight / 1000).toFixed(4));
            } else if (settings.nethash_units == 'G') {
                return cb((body.netstakeweight / 1000).toFixed(4));
            } else if (settings.nethash_units == 'H') {
                ...
                return cb((body.netstakeweight / 1000000000).toFixed(4));
            } else {
                return cb(body.netstakeweight.toFixed(4));
            }
